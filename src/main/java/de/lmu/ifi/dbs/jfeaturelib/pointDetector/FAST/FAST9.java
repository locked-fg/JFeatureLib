...
public class FAST9 {
    ...
    private List<ImagePoint> fast9_detect(int[] im, int xsize, int ysize, int stride, int b, int ret_num_corners) {
        int num_corners = 0;
    ...
    private int fast9_corner_score(int[] p, int[] pixel, int bstart, ImagePoint currentP, int stride) {
        bmin = bstart;
        bmax = 255;
        b = (bmax + bmin) / 2;
        endScore = false;
